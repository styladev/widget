/*!
 * Styla bite-sized widget v1.3.2
...
var specificStyles = '#styla-widget.cards .styla-widget__container{display:-moz-flex;display:-webkit-flex;display:-ms-flex;display:flex;flex-direction:row;-webkit-flex-direction:row;-moz-flex-direction:row;-mz-flex-direction:row;flex-wrap:wrap;-moz-flex-wrap:wrap;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;padding:.5em}#styla-widget.cards .styla-widget__story{margin:.5em;width:18em;height:100%;display:block;float:left;flex-grow:1;-moz-flex-grow:1;-ms-flex-grow:1;-webkit-flex-grow:1}#styla-widget.cards .styla-widget__link{display:block}#styla-widget.cards .styla-widget__imagewrap{height:11em;width:100%}#styla-widget.cards .styla-widget__image{width:100%;object-fit:cover}#styla-widget.cards .styla-widget__headline{font-size:1.5em}#styla-widget.cards .styla-widget__paragraph{max-height:6em}';
