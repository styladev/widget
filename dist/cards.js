...
var specificStyles = '#styla-widget.cards .styla-widget__container{display:-moz-flex;display:-ms-flex;display:-webkit-flex;display:flex;-moz-flex-direction:row;-ms-flex-direction:row;-webkit-flex-direction:row;flex-direction:row;-moz-flex-wrap:wrap;-ms-flex-wrap:wrap;-webkit-flex-wrap:wrap;flex-wrap:wrap;padding:0 .5em;min-height:26em}#styla-widget.cards .styla-widget__story{margin:.5em;width:18em;height:100%;display:block;float:left;-moz-flex-grow:1;-ms-flex-grow:1;-webkit-flex-grow:1;flex-grow:1}#styla-widget.cards .styla-widget__link{display:block}#styla-widget.cards .styla-widget__imagewrap{height:11em;width:100%}#styla-widget.cards .styla-widget__image{width:100%;object-fit:cover}#styla-widget.cards .styla-widget__textwrap{width:100%}#styla-widget.cards .styla-widget__headline{font-size:1.5em}#styla-widget.cards .styla-widget__paragraph{max-height:6em}#styla-widget.cards .styla-widget__calltoaction{line-height:2em}#styla-widget.cards .styla-widget__calltoaction:hover{text-decoration:underline}';
