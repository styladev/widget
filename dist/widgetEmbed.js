...
},{"./classes.js":2,"./version.js":3,"microbejs/dist/microbe.http.min":1}],5:[function(require,module,exports){
'use strict';
...
var config = {
    ...
    domainConfigAPI: 'https://www.amazine.com/api/config/'
};

var widget = window.widget = new _widget2['default'](config);
